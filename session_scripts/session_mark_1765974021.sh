#!/bin/bash
# Session script for local_mark_1765974021
# Profile: /workspace/chrome_profiles/account_mark

echo "Session: local_mark_1765974021"
...
alias session-info='echo "Session: local_mark_1765974021" && echo "Profile: /workspace/chrome_profiles/account_mark"'
